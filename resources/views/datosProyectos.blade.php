...
<div class="container mt-4">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-body text-center p-5">
            <form action="{{ route('proyectos.importar') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <!-- Área de carga -->
                <div class="mb-3">
     ...
     <div class="card shadow-sm mb-4 text-center">
        <div class="card-body">
            <a href="{{route('mapa.proyectos')}}" class="btn btn-danger">
                ...
                <td colspan="9">
                    <div class="card shadow-sm mb-3">
                        <div class="card-body">
                            ...
                            <p class="mb-1"><strong>Folio PPI:</strong> {{ $row->folio_ppi }}</p>
                            <p class="mb-1"><strong>CCT:</strong> {{ $row->cct }}</p>
                            <p class="mb-1"><strong>Municipio:</strong> {{ $row->municipio }}</p>
                            <p class="mb-1"><strong>Empresa:</strong> {{ $row->empresa }}</p>
                            <p class="mb-1"><strong>Monto:</strong> {{ number_format($row->monto_inversion, 2) }}</p>
