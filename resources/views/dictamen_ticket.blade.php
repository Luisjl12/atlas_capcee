...
<form action="{{ route('tickets.guardarDictamen', $ticket->id) }}" method="POST">
    @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="telefono_solicitante" id="telefono_solicitante"
                            class="form-control"
                            value="{{ old('telefono_solicitante', $ticket->solicitante->telefono_solicitante ?? '')}}">
                    </div>
                    <div class="mb-3">
                        ...
                        <input type ="text" name="correo_solicitante" id ="correo_solicitante"
                            class="form-control"
                            value ="{{old('correo_solicitante', $ticket->solicitante->correo_solicitante ?? '')}}">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="correo_turna" id = "correo_turna"
                            class="form-control"
                            value="{{ old('correo_turna', $ticket->solicitante->correo_turna ?? '')}}">
                    </div>
                </div>
            </div>
        </div>
