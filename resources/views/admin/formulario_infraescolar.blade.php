...
<div class="container mt-4">
    ...
    <div class="card shadow mb-4 p-4">
        ...
        <div class="card mb-2">
            <div class="card-body">
                <h6 class="fw-bold">{{ $rep->titulo }}</h6>
                <p class="text-muted">{{ $rep->created_at->format('d/m/Y') }}</p>
                <div class="d-flex gap-2">
                    <a href="{{ route('infraescolar.edit', $rep->id) }}" class="btn btn-warning btn-sm">Editar</a>
                    <form action="{{ route('infraescolar.destroy', $rep->id) }}" method="POST">
                        @csrf @method('DELETE')
