...
@section('title', 'Ubicación del Plantel')
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const plantelData = {
        lat: {{ $escuela->latitud }},
        lng: {{ $escuela->longitud }},
        nombre: "{!! htmlspecialchars($escuela->plantel, ENT_QUOTES) !!}", // htmlspecialchars evita que comillas rompan el JS
        cct: "{{ $escuela->cct }}"
    };
