...
<form action="<?php echo e(route('tickets.guardarDictamen', $ticket->id)); ?>" method="POST">
    <?php echo csrf_field(); ?>
        ...
        <div class="tab-pane fade show active" id="tab-0">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <label for="telefono_solicitante" class="form-label">Telefono Solicitante</label>
                        <input type="text" name="telefono_solicitante" id="telefono_solicitante"
                            class="form-control"
                            value="<?php echo e(old('telefono_solicitante', $ticket->solicitante->telefono_solicitante ?? '')); ?>">
                    </div>
                    <div class="mb-3">
                        <label for="correo_solicitante" class="form-label">Correo Electronico</label>
                        <input type ="text" name="correo_solicitante" id ="correo_solicitante"
                            class="form-control"
                            value ="<?php echo e(old('correo_solicitante', $ticket->solicitante->correo_solicitante ?? '')); ?>">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="tab-pane fade" id="tab-1">
            ...
            <div class="card mb-4">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <label for="correo_turna" class="form-label">Correo de la persona que turna</label>
                        <input type="text" name="correo_turna" id = "correo_turna"
                            class="form-control"
                            value="<?php echo e(old('correo_turna', $ticket->solicitante->correo_turna ?? '')); ?>">
                    </div>
                </div>
            </div>
        </div>
