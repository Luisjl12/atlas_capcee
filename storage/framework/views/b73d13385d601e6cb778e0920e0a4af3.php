...
<?php $__env->startSection('title', 'Comparar Infraestructura'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="form-ficha-base">
        ...
        <form action="<?php echo e(route('infraestructura.comparar')); ?>" method="POST">
            <?php echo csrf_field(); ?>
        ...
        <form action="<?php echo e(route('comparacion.edificios.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
        ...
        <form action="<?php echo e(route('comparacion.agua.store')); ?>" method="POST">
            <?php echo csrf_field(); ?>
