...
<?php if(session('foto_subida')): ?>
<div class="alert alert-success">
    Foto subida correctamente
    <img src="<?php echo e(session('foto_subida')); ?>" alt="Foto subida" class="img-thumbnail mt-2" width="200">
</div>
<?php endif; ?>
<form action="<?php echo e(route ('galeria.store', $plantel->cct)); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
    <div class="mb-3">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
        ...
        <div class="d-flex align-items-center gap-3">
            ...
            <button type="button" id="btnEliminarSeleccionadas" class="btn-custom btn-danger"
                data-url="<?php echo e(route('galeria.eliminarSeleccionadas')); ?>">
...
</script><?php /**PATH /home1/bcecacef/atlasinfraescolarpueblaa.online/resources/views/planteles/galeria/formulario.blade.php ENDPATH**/ ?>