<div class="table-responsive mt-3 data-table-container">
            ...
            <tr class="d-none d-md-table-row">
                ...
                <td>
                    <div class="acciones-btns d-flex align-items-center gap-1 flex-nowrap">
                        ...
                        <a href="<?php echo e(route('planteles.edit', $plantel->id)); ?>" class="btn btn-sm btn-primary custom-tooltip">
                            <i class="fas fa-pen"></i>
                            <span class="tooltiptext">Editar</span>
                        </a>
                        <button type="button" class="btn btn-sm btn-danger"
                            onclick="mostrarModalConfirmacion('¿Seguro que quieres eliminar a este plantel?', '<?php echo e(route('planteles.destroy', $plantel->id)); ?>')">
    ...
    <?php endif; ?><?php /**PATH /home1/bcecacef/atlasinfraescolarpueblaa.online/resources/views/partials/lista.blade.php ENDPATH**/ ?>