...
<?php $__env->startSection('title', 'Mapa Global - Escuelas al 100'); ?>
...
<div class="container-fluid mt-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="<?php echo e(url('/admin')); ?>" class="btn btn-outline-secondary">
...
document.addEventListener('DOMContentLoaded', function() {
    const planteles = <?php echo json_encode($planteles, 15, 512) ?>;
...
fetch("<?php echo e(asset('geojson/municipios_limpios_dos.json')); ?>")
    .then(res => res.json())
    .then(municipiosData => {
        ...
        return fetch("<?php echo e(asset('geojson/puebla_limpio_dos.json')); ?>");
    })
    .then(res => res.json())
    .then(estadoData => {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\atlas_local\resources\views/reportes/mapa_escuelas100_general.blade.php ENDPATH**/ ?>